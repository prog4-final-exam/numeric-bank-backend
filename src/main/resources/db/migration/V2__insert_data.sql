INSERT INTO
    account (
        id, firstname, lastname, birthdate, net_monthly_pay, account_number, overdraft_allowed
    )
SELECT *
FROM (
        VALUES (
                1, 'Jean', 'Dupont', DATE '1980-01-01', 35000, 'FR7630004000031234567890143', false
            ), (
                2, 'Marie', 'Durand', DATE '1982-02-02', 45000, 'FR7630006000011234567890189', true
            ), (
                3, 'Pierre', 'Martin', DATE '1975-03-03', 30000, 'FR7630007000021234567890123', false
            ), (
                4, 'Julie', 'Lemoine', DATE '1985-04-04', 40000, 'FR7630008000031234567890156', true
            ), (
                5, 'Luc', 'Bernard', DATE '1978-05-05', 50000, 'FR7630009000041234567890187', false
            ), (
                6, 'Sophie', 'Petit', DATE '1980-06-06', 35000, 'FR7630010000051234567890145', true
            ), (
                7, 'Nicolas', 'Roux', DATE '1982-07-07', 45000, 'FR7630011000061234567890178', false
            ), (
                8, 'Camille', 'Moreau', DATE '1979-08-08', 40000, 'FR7630012000071234567890190', true
            ), (
                9, 'Alexandre', 'Lefevre', DATE '1981-09-09', 45000, 'FR7630013000081234567890122', false
            ), (
                10, 'Sarah', 'Garnier', DATE '1983-10-10', 50000, 'FR7630014000091234567890154', true
            )
    ) AS new_account (
        id, firstname, lastname, birthdate, net_monthly_pay, account_number, overdraft_allowed
    )
